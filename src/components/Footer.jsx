      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-300 text-sm md:text-base">
            ...
            <li><Link to="/blog" className="hover:text-accent">Blog & Tips</Link></li>
        ...
        <div>
          ...
          <p className="text-gray-300 mb-2 text-sm md:text-base">📞 +971529933482</p>
          <p className="text-gray-300 mb-6 text-sm md:text-base">✉️ fakharalmas@gmail.com</p>
          <a href="https://wa.me/971529933482" target="_blank" className="inline-flex bg-white/10 text-white border border-accent/50 px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold items-center gap-3 hover:bg-accent transition-colors shadow-md">
